...
State currentState = WAITING_FOR_WALLET;  // Start in waiting state

String received, startTime, endTime, curDate;
bool showed = false;  //to track if data was shown to the user in this connection

// Pulse Sensor Inputs
const int PulseWire1 = A3;   // Sensor for rotary encoder
const int PulseWire2 = A10;  // Sensor for button press
int Threshold = 550;
